                    ...
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-gray-500 dark:text-gray-500 uppercase tracking-wider">
                                {{ $submission->code }} &middot; {{ $submission->created_at->diffForHumans() }}
                            </p>
                        </div>
                    </div>
                            ...
                            <ul class="space-y-2.5">
                                <li class="flex items-start gap-2.5">
                                    ...
                                    <span class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('Hanya pengajuan status menunggu yang bisa diedit') }}
                                    </span>
                                </li>
                                <li class="flex items-start gap-2.5">
                                    <div class="shrink-0 mt-0.5 w-1.5 h-1.5 rounded-full bg-purple-500"></div>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('Perubahan akan langsung tersimpan') }}
                                    </span>
                                </li>
                            </ul>
                        </div>
